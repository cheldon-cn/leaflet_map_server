...
### ReadLockGuard / WriteLockGuard (读写锁守卫)

**File**: [thread_safe.h](ogc/base/thread_safe.h)  
**Description**: RAII风格的读写锁守卫，自动管理锁的获取和释放

```cpp
namespace ogc {
namespace base {

class OGC_BASE_API ReadLockGuard {
public:
...
class OGC_BASE_API WriteLockGuard {
public:
...
### SpinLock / SpinLockGuard (自旋锁)

**File**: [thread_safe.h](ogc/base/thread_safe.h)  
**Description**: 高性能自旋锁，适用于短时间锁定场景

```cpp
namespace ogc {
namespace base {

class OGC_BASE_API SpinLock {
public:
    SpinLock();
    void Lock();
    void Unlock();
...
class OGC_BASE_API SpinLockGuard {
public:
...
**File**: [thread_safe.h](ogc/base/thread_safe.h)  
**Description**: 线程安全的原子计数器

```cpp
namespace ogc {
namespace base {

class OGC_BASE_API AtomicCounter {
public:
    AtomicCounter();
...
### ThreadSafeFlag (线程安全标志)

**File**: [thread_safe.h](ogc/base/thread_safe.h)  
**Description**: 线程安全的布尔标志，支持等待操作

```cpp
namespace ogc {
namespace base {

class OGC_BASE_API ThreadSafeFlag {
public:
    ThreadSafeFlag();
    explicit ThreadSafeFlag(bool initial);
...
**File**: [performance_metrics.h](ogc/base/performance_metrics.h)  
**Description**: 收集和管理性能指标的辅助类
...
// 读操作（可并发）
{
    ReadLockGuard readGuard(rwlock);
    // 读取共享数据
}

// 写操作（独占）
{
    WriteLockGuard writeGuard(rwlock);
    // 修改共享数据
}
