#ifndef OGC_GRAPH_IMAGE_DRAW_H
#define OGC_GRAPH_IMAGE_DRAW_H
...
public:
    ...
    ogc::draw::Color GetPixel(int x, int y) const;
    void SetPixel(int x, int y, const ogc::draw::Color& color);
    
    void Fill(const ogc::draw::Color& color);
    void Clear();
...
public:
    ...
    void DrawLine(int x1, int y1, int x2, int y2, const ogc::draw::Color& color, int thickness = 1);
    void DrawLineAA(int x1, int y1, int x2, int y2, const ogc::draw::Color& color, int thickness = 1);
    
    void DrawRect(int x, int y, int width, int height, const ogc::draw::Color& color, int thickness = 1);
    void FillRect(int x, int y, int width, int height, const ogc::draw::Color& color);
    
    void DrawCircle(int cx, int cy, int radius, const ogc::draw::Color& color, int thickness = 1);
    void FillCircle(int cx, int cy, int radius, const ogc::draw::Color& color);
    
    void DrawEllipse(int cx, int cy, int rx, int ry, const ogc::draw::Color& color, int thickness = 1);
    void FillEllipse(int cx, int cy, int rx, int ry, const ogc::draw::Color& color);
    
    void DrawPolygon(const std::vector<std::pair<int, int>>& points, const ogc::draw::Color& color, int thickness = 1);
    void FillPolygon(const std::vector<std::pair<int, int>>& points, const ogc::draw::Color& color);
    
    void DrawText(int x, int y, const std::string& text, const ogc::draw::Color& color, const std::string& fontFamily = "", int fontSize = 12);
    ...
    void Blend(int x, int y, const ogc::draw::Color& color, double alpha);
    
    void Clear(const ogc::draw::Color& color);
...
private:
    ...
    void DrawLineBresenham(int x1, int y1, int x2, int y2, const ogc::draw::Color& color, int thickness);
    void DrawLineXiaolinWu(int x1, int y1, int x2, int y2, const ogc::draw::Color& color, int thickness);
    
    void DrawCircleMidpoint(int cx, int cy, int radius, const ogc::draw::Color& color, int thickness);
    void FillCircleScanline(int cx, int cy, int radius, const ogc::draw::Color& color);
    
    void DrawEllipseMidpoint(int cx, int cy, int rx, int ry, const ogc::draw::Color& color, int thickness);
    void FillEllipseScanline(int cx, int cy, int rx, int ry, const ogc::draw::Color& color);
    
    void FillPolygonScanline(const std::vector<std::pair<int, int>>& points, const ogc::draw::Color& color);
