...
| [qt_chart_view.h](ogc/draw/qt_chart_view.h) | Qt图表视图 | `QtChartView` |
| [qt_resource_manager.h](ogc/draw/qt_resource_manager.h) | Qt资源管理 | `QtResourceManager` |
| [qt_window_manager.h](ogc/draw/qt_window_manager.h) | Qt窗口管理 | `QtWindowManager` |
| [qt_event_adapter.h](ogc/draw/qt_event_adapter.h) | Qt事件适配 | `QtEventAdapter` |
| [draw_version.h](ogc/draw/draw_version.h) | 版本信息 | `DrawVersion` |
| [library_compatibility.h](ogc/draw/library_compatibility.h) | 库兼容性 | `LibraryCompatibility` |
| [draw_scope_guard.h](ogc/draw/draw_scope_guard.h) | 作用域守卫 | `DrawScopeGuard` |
| [gpu_device_selector.h](ogc/draw/gpu_device_selector.h) | GPU设备选择 | `GPUDeviceSelector` |
| [capability_negotiator.h](ogc/draw/capability_negotiator.h) | 能力协商 | `CapabilityNegotiator` |
| [state_serializer.h](ogc/draw/state_serializer.h) | 状态序列化 | `StateSerializer` |
...
| v1.1 | 2026-04-09 | index-validator | 补充12个缺失头文件(clipper.h, qt_*.h, draw_version.h等) |
