#ifndef OGC_PORTRAYAL_PARSER_ALERT_CATALOG_PARSER_H
#define OGC_PORTRAYAL_PARSER_ALERT_CATALOG_PARSER_H
...
class OGC_PORTRAYAL_API AlertCatalogParser : public ElementParser {
public:
