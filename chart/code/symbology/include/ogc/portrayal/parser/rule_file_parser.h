#ifndef OGC_PORTRAYAL_PARSER_RULE_FILE_PARSER_H
#define OGC_PORTRAYAL_PARSER_RULE_FILE_PARSER_H
...
class OGC_PORTRAYAL_API RuleFileParser : public ElementParser {
public:
