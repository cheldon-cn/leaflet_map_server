#ifndef OGC_PORTRAYAL_PARSER_LINE_STYLE_PARSER_H
#define OGC_PORTRAYAL_PARSER_LINE_STYLE_PARSER_H
...
class OGC_PORTRAYAL_API LineStyleParser : public ElementParser {
public:
