#ifndef OGC_PORTRAYAL_PARSER_AREA_FILL_PARSER_H
#define OGC_PORTRAYAL_PARSER_AREA_FILL_PARSER_H
...
class OGC_PORTRAYAL_API AreaFillParser : public ElementParser {
public:
