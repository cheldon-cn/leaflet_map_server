...
public:
    ...
    MOCK_METHOD(DeviceCapabilities, GetCapabilities, (), (const, override));
};
...
public:
    ...
    MOCK_METHOD(DrawDevice*, GetDevice, (), (override));
    MOCK_METHOD(const DrawDevice*, GetDevice, (), (const, override));
    ...
    MOCK_METHOD(void, PopState, (), (override));
