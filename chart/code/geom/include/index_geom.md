...
|---------|------|--------|---------|
| v1.0 | 2026-01-01 | Team | 初始版本，实现基础几何类型 |
| v1.1 | 2026-02-15 | Team | 添加空间索引支持 |
| v1.2 | 2026-03-10 | Team | 添加GeoJSON/GML/KML序列化 |
| v1.3 | 2026-03-20 | Team | 添加访问者模式和对象池 |
