 ...
 * @brief 几何访问者基类（只读）
 */
class OGC_API GeometryConstVisitor {
public:
 ...
 * @brief 面积计算访问者
 */
class OGC_API AreaCalculator : public GeometryConstVisitor {
public:
 ...
 * @brief 几何统计访问者
 */
class OGC_API GeometryStatistics : public GeometryConstVisitor {
public:
