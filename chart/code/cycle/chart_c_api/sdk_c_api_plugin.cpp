...
SDK_C_API void ogc_error_recovery_manager_destroy(ogc_error_recovery_manager_t* recovery) {
    delete reinterpret_cast<ErrorRecoveryData*>(recovery);
}

SDK_C_API int ogc_error_recovery_manager_initialize(ogc_error_recovery_manager_t* recovery) {
    if (recovery) {
...
SDK_C_API void ogc_error_recovery_manager_shutdown(ogc_error_recovery_manager_t* recovery) {
    if (recovery) {
        reinterpret_cast<ErrorRecoveryData*>(recovery)->Shutdown();
    }
}

SDK_C_API int ogc_error_recovery_manager_save_state(ogc_error_recovery_manager_t* recovery, const char* name) {
    if (recovery && name) {
...
SDK_C_API int ogc_error_recovery_manager_restore_state(ogc_error_recovery_manager_t* recovery, const char* name) {
    if (recovery && name) {
...
SDK_C_API int ogc_error_recovery_manager_delete_state(ogc_error_recovery_manager_t* recovery, const char* name) {
    if (recovery && name) {
...
SDK_C_API int ogc_error_recovery_manager_get_state_count(const ogc_error_recovery_manager_t* recovery) {
    if (recovery) {
...
SDK_C_API const char* ogc_error_recovery_manager_get_state_name(const ogc_error_recovery_manager_t* recovery, int index) {
    if (recovery) {
...
SDK_C_API int ogc_health_check_run(ogc_health_check_t* health) {
    if (health) {
...
SDK_C_API int ogc_health_check_is_healthy(const ogc_health_check_t* health) {
    if (health) {
...
SDK_C_API int ogc_health_check_get_issue_count(const ogc_health_check_t* health) {
    if (health) {
...
SDK_C_API const char* ogc_health_check_get_issue(const ogc_health_check_t* health, int index) {
    if (health) {
...
SDK_C_API void ogc_health_check_clear_issues(ogc_health_check_t* health) {
    if (health) {
...
SDK_C_API int ogc_library_loader_is_loaded(ogc_library_loader_t* loader, ogc_library_handle_t handle) {
    if (loader && handle) {
...
SDK_C_API int ogc_exception_get_last_code(void) {
    return ExceptionData::GetLastCode();
}

SDK_C_API const char* ogc_exception_get_last_message(void) {
    return ExceptionData::GetLastMessage().c_str();
}

SDK_C_API void ogc_exception_clear(void) {
    ExceptionData::Clear();
}

SDK_C_API int ogc_exception_has_error(void) {
