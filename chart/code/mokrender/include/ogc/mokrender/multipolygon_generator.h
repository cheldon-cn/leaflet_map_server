#ifndef OGC_MOKRENDER_MULTIPOLYGON_GENERATOR_H
#define OGC_MOKRENDER_MULTIPOLYGON_GENERATOR_H
...
class OGC_MOKRENDER_API MultiPolygonGenerator : public IFeatureGenerator {
public:
    MultiPolygonGenerator();
    ~MultiPolygonGenerator() override;
