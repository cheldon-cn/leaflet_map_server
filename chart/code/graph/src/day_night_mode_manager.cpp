...
Color DayNightModeManager::TransformColor(const Color& color) const {
    return TransformColorForMode(color, m_currentMode);
}

Color DayNightModeManager::TransformColorForMode(const Color& color, DisplayMode mode) const {
...
ColorScheme DayNightModeManager::CreateDefaultDayScheme() {
    ColorScheme scheme;
    scheme.name = "Day";
    scheme.backgroundColor = Color(255, 255, 255);
    scheme.waterColor = Color(173, 216, 230);
    scheme.landColor = Color(210, 180, 140);
    scheme.textColor = Color(0, 0, 0);
    scheme.highlightColor = Color(255, 255, 0);
    scheme.selectionColor = Color(0, 255, 0);
    scheme.gridColor = Color(200, 200, 200);
    scheme.routeColor = Color(255, 0, 0);
    scheme.dangerColor = Color(255, 0, 0);
    scheme.safeWaterColor = Color(0, 128, 0);
    scheme.contrast = 1.0;
...
ColorScheme DayNightModeManager::CreateDefaultNightScheme() {
    ColorScheme scheme;
    scheme.name = "Night";
    scheme.backgroundColor = Color(20, 20, 40);
    scheme.waterColor = Color(30, 40, 80);
    scheme.landColor = Color(60, 50, 40);
    scheme.textColor = Color(200, 200, 200);
    scheme.highlightColor = Color(255, 255, 100);
    scheme.selectionColor = Color(100, 255, 100);
    scheme.gridColor = Color(80, 80, 100);
    scheme.routeColor = Color(255, 100, 100);
    scheme.dangerColor = Color(255, 50, 50);
    scheme.safeWaterColor = Color(50, 200, 50);
    scheme.contrast = 1.2;
...
ColorScheme DayNightModeManager::CreateDefaultDuskScheme() {
    ColorScheme scheme;
    scheme.name = "Dusk";
    scheme.backgroundColor = Color(255, 200, 150);
    scheme.waterColor = Color(100, 120, 160);
    scheme.landColor = Color(180, 140, 100);
    scheme.textColor = Color(50, 30, 20);
    scheme.highlightColor = Color(255, 255, 150);
    scheme.selectionColor = Color(100, 255, 100);
    scheme.gridColor = Color(180, 160, 140);
    scheme.routeColor = Color(255, 80, 80);
    scheme.dangerColor = Color(255, 50, 50);
    scheme.safeWaterColor = Color(50, 150, 50);
    scheme.contrast = 1.1;
...
ColorScheme DayNightModeManager::CreateDefaultDawnScheme() {
    ColorScheme scheme;
    scheme.name = "Dawn";
    scheme.backgroundColor = Color(255, 220, 200);
    scheme.waterColor = Color(120, 140, 180);
    scheme.landColor = Color(190, 160, 130);
    scheme.textColor = Color(40, 30, 20);
    scheme.highlightColor = Color(255, 255, 180);
    scheme.selectionColor = Color(100, 255, 100);
    scheme.gridColor = Color(190, 180, 170);
    scheme.routeColor = Color(255, 100, 80);
    scheme.dangerColor = Color(255, 60, 50);
    scheme.safeWaterColor = Color(60, 160, 60);
