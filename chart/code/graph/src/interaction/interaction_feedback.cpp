...
using ogc::symbology::PointSymbolizer;
using ogc::symbology::LineSymbolizer;
using ogc::symbology::PolygonSymbolizer;
using ogc::symbology::TextSymbolizer;
