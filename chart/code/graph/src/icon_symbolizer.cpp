...
DrawResult IconSymbolizer::Symbolize(DrawContextPtr context, const Geometry* geometry) {
        ...
        if (multiPoint) {
            ...
            for (size_t i = 0; i < multiPoint->GetNumPoints(); ++i) {
                ...
                if (pt) {
                    ...
                    DrawResult r = DrawIcon(context, x, y);
...
DrawResult IconSymbolizer::DrawIcon(DrawContextPtr context, double x, double y) {
