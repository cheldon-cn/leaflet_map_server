#ifndef OGC_DRAW_S52_STYLE_MANAGER_H
#define OGC_DRAW_S52_STYLE_MANAGER_H
...
class OGC_GRAPH_API ColorSchemeManager {
public:
...
class OGC_GRAPH_API SymbolLibrary {
public:
...
class OGC_GRAPH_API StyleRuleEngine {
public:
...
class OGC_GRAPH_API DisplayPriorityCalculator {
public:
...
class OGC_GRAPH_API S52StyleManager {
public:
