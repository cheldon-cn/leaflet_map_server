#ifndef OGC_DRAW_DAY_NIGHT_MODE_MANAGER_H
#define OGC_DRAW_DAY_NIGHT_MODE_MANAGER_H
...
public:
    ...
    Color TransformColorForMode(const Color& color, DisplayMode mode) const;
