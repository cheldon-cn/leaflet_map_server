...
public:
    ...
    CoordinateTransformerPtr GetTransformer(const std::string& sourceCRS, const std::string& targetCRS);
    
    void RegisterTransformer(const std::string& sourceCRS, const std::string& targetCRS, CoordinateTransformerPtr transformer);
    ...
    CoordinateTransformerPtr CreateTransformer(const std::string& sourceCRS, const std::string& targetCRS);
    ...
    static CoordinateTransformerPtr GetWGS84ToWebMercator();
    static CoordinateTransformerPtr GetWebMercatorToWGS84();
...
private:
    ...
    std::unordered_map<std::string, CoordinateTransformerPtr> m_cache;
