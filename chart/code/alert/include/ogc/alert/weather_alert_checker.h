#ifndef OGC_ALERT_WEATHER_ALERT_CHECKER_H
#define OGC_ALERT_WEATHER_ALERT_CHECKER_H
...
class OGC_ALERT_API WeatherAlertChecker : public IAlertChecker {
public:
    WeatherAlertChecker();
    ~WeatherAlertChecker();
    ...
    static std::unique_ptr<WeatherAlertChecker> Create();
